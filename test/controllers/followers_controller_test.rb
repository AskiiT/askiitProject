...
class FollowersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create follower" do
    assert_difference('Follower.count') do
      post followers_url, params: { follower: { user_id: @follower.user_id, user_id: @follower.user_id } }
    end
  ...
  test "should update follower" do
    patch follower_url(@follower), params: { follower: { user_id: @follower.user_id, user_id: @follower.user_id } }
