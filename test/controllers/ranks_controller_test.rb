...
class RanksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rank" do
    assert_difference('Rank.count') do
      post ranks_url, params: { rank: { clarity: @rank.clarity, efectiveness: @rank.efectiveness, quickness: @rank.quickness, user_id: @rank.user_id } }
    end
  ...
  test "should update rank" do
    patch rank_url(@rank), params: { rank: { clarity: @rank.clarity, efectiveness: @rank.efectiveness, quickness: @rank.quickness, user_id: @rank.user_id } }
